...
public class AirServiceImplTest {
    ...
    public void getAirQualityByLocalNFeatures_NotInCache_Test(){
        ...
        verify(airRepository, times(1)).putData(0, 0, anyString());
        verify(airRepository, times(1)).getData(0, 0);

    }

    @Test
    public void getAirQualityByLocalNFeatures_InCache_Test(){
        when(airRepository.getData(0, 0)).thenReturn(this.airRequest);
        ...
        assertEquals(airExpected, airResult);
        verify(airRepository, times(0)).putData(0, 0, anyString());
        verify(airRepository, times(1)).getData(0, 0);
