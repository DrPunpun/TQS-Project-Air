...
public class AirRestControllerTest {
    ...
    public void whenRightParams_ShouldReturnRightResult() throws Exception {
        ...
        when(airService.getAirQualityByLocal(anyFloat(), anyFloat(), any(String[].class)))
        ...
        verify(airService, times(1)).getAirQualityByLocal(anyFloat(), anyFloat(), any(String[].class));
        reset(airService);
    }
}
